...
export class UsersController {
  ...
  @ApiResponse({
    status: 403,
    description: 'Accès refusé : seuls les OWNER peuvent créer un utilisateur.',
  })
  ...
  @Roles('OWNER', 'ARBITRE')
  @ApiOperation({
    summary: 'Afficher la liste des utilisateurs (OWNER et ARBITRE uniquement)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 403,
    description: 'Tu ne peux modifier que ton propre compte.',
  })
  async update(
    @Param('id') id: string,
  ...
  @ApiResponse({
    status: 403,
    description:
      'Accès refusé : seuls les OWNER peuvent supprimer un utilisateur.',
  })
